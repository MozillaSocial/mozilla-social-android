...
import org.mozilla.social.core.domain.Login.Companion.CLIENT_NAME
import org.mozilla.social.core.domain.Login.Companion.CODE
import org.mozilla.social.core.domain.Login.Companion.REDIRECT_URI
import org.mozilla.social.core.domain.Login.Companion.SCOPES
...
class LoginTest {
    ...
    @Test
    fun `user is logged out when fetch oauth token throws error`() = runTest {
        coEvery {
            oauthRepository.fetchOAuthToken(
                any(),
                any(),
    ...
    @Test
    fun saveAccessTokenThrowsError_userIsLoggedOut() = runTest {
    ...
    @Test
    fun verifyUserCredentialsThrowsError_userIsLoggedOut() = runTest {
    ...
    @Test
    fun saveAccountIdThrowsError_userIsLoggedOut() = runTest {
    ...
    @Test
    fun saveAnalyticsCredentialsThrowsError_userIsLoggedOut() = runTest {
