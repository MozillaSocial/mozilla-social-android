...
@Composable
fun unfavoriteAccountConfirmationDialog(
    onConfirmation: () -> Unit
) : DialogOpener {
    ...
    if (isOpen) {
        FfAlertDialog(
            ...
            title = {
                Text(
                    text = stringResource(id = R.string.unfavorite_post_confirmation)
                )
            },
            confirmButton = {
                FfTextButton(
                    ...
                    Text(text = stringResource(id = R.string.unfavorite_post_confirmed))
                }
            },
            dismissButton = {
