...
@Composable
fun unbookmarkAccountConfirmationDialog(
    onConfirmation: () -> Unit
) : DialogOpener {
    ...
    if (isOpen) {
        FfAlertDialog(
            ...
            title = {
                Text(
                    text = stringResource(id = R.string.unbookmark_post_confirmation)
                )
            },
            confirmButton = {
                FfTextButton(
                    ...
                    Text(text = stringResource(id = R.string.unbookmark_post_confirmed))
                }
            },
            dismissButton = {
