...
class HomeTimelineRemoteMediator(
    ...
    private val localHomeTimelineRepository: LocalHomeTimelineRepository,
        ...
        return try {
            ...
            databaseDelegate.withTransaction {
                if (loadType == LoadType.REFRESH) {
                    localHomeTimelineRepository.deleteHomeTimeline()
                }

                saveStatusesToDatabase(result)

                localHomeTimelineRepository.insertAll(result)
            }
